...
class FlutterPackageManagerPlugin: FlutterPlugin, MethodCallHandler {
  ...
  override fun onAttachedToEngine(@NonNull flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
    ...
    channel = MethodChannel(flutterPluginBinding.binaryMessenger, METHOD_CHANNEL, JSONMethodCodec.INSTANCE)
...
//  override fun onMethodCall(@NonNull call: MethodCall, @NonNull result: Result) {
//    Log.i(TAG, "onMethodCall with ${call.method}")
//
//    when(call.method) {
//      "getPlatformVersion" -> {
//        result.success("Android ${android.os.Build.VERSION.RELEASE}")
